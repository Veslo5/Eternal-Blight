...
function slice:New(texture, leftPadding, rightPadding, topPadding, bottomPadding)
	...
	newInstance.padding = { leftPadding = leftPadding, rightPadding = rightPadding, topPadding = topPadding,
...
function slice:draw(x, y, sx, sy)
	...
	for index, quad in ipairs(self.sourceQuads) do
		love.graphics.draw(self.texture ,quad, x,y, 0, sx, sy)
	end
end
